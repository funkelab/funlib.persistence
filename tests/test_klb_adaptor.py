...
class TestArray(unittest.TestCase):
    def write_test_klb(self):
        ...
        pyklb.writefull(
            data, self.klb_file, numthreads=1, pixelspacing_tczyx=[1, 1, 2, 1, 1]
        )
    ...
    def test_load_klb(self):
        ...
        self.assertEqual(data.roi.get_shape(), daisy.Coordinate((1, 20, 10, 10)))
    ...
    def test_overwrite_attrs(self):
        self.write_test_klb()
        data = daisy.open_ds(self.klb_file, None, attr_filename=self.attrs_file)
        self.assertEqual(data.roi.get_offset(), daisy.Coordinate((0, 100, 10, 0)))
        self.assertEqual(data.roi.get_shape(), daisy.Coordinate((1, 10, 20, 20)))
